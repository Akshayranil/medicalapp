        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              ElevatedButton(onPressed:isBmiCalculated? saveBMI:null,style: ElevatedButton.styleFrom(backgroundColor: Colors.blue), child: Text("Save BMI",style: TextStyle(color: Colors.white),)),
